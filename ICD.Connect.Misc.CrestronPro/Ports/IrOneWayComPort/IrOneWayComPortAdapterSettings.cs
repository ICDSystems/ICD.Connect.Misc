...
{
	[KrangSettings("IrOneWayComPort", typeof(IrOneWayComPortAdapter))]
	public sealed class IrOneWayComPortAdapterSettings : AbstractComPortSettings
	{
		...
		/// Constructor.
		/// </summary>
		public IrOneWayComPortAdapterSettings()
		{
			Address = 1;
		}
