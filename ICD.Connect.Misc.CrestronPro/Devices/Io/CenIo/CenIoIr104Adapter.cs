...
{
#if SIMPLSHARP
	public sealed class CenIoIr104Adapter : AbstractCenIoIrAdapter<CenIoIr104, CenIoIr104AdapterSettings>
#else
	public sealed class CenIoIr104Adapter : AbstractCenIoIrAdapter<CenIoIr104AdapterSettings>
#endif
	{
#if SIMPLSHARP
		/// <summary>
